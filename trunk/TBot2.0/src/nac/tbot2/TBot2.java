  ...
  public TBot2() {
    ...
    boardWatcher.setBoardListener(new BoardListener() {
      ...
      public void onNextAreaChange(Tetramino[] tetramino) {
        ...
        System.out.println("next change" + Arrays.toString(tetramino));
  ...
  @SuppressWarnings("unchecked")
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
      try {
        ...
        preferences.putByteArray(PREF_MAP, TBotUtils.serialize(TetraminoFactory.getMap()));
      } catch (Exception ex) {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
      try {
        ...
        if (d != null) {
         ...
         d = preferences.getByteArray(PREF_MAP, null);
         Map<Integer, Tetramino[]> map = null;
        if (d != null) {
          map = (Map<Integer, Tetramino[]>) TBotUtils.deserialize(d);
          if (map != null) {
            System.out.println("map:" + map);
            TetraminoFactory.setMap(map);
          }
